...
app.put("/api/update/", (req, res) => {
	let sql = "UPDATE student SET firstname='" + req.body.firstname + "', lastname='" + req.body.lastname + "',aadharno='" + req.body.aadharno + "',mobileno='" + req.body.mobileno + "' WHERE id=" + req.body.id;
	let query = conn.query(sql, (err, result) => {
		if (err) throw err;
